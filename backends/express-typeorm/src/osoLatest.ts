...
export async function initOso() {
    ...
    issueType.set('repo', new Relation('parent', 'Repo', 'repoId', 'id'));
    ...
    orgType.set('orgRoles', new Relation('chlidren', 'OrgRole', 'id', 'orgId'));
    ...
    const repoFiles = {
        id: Number,
        org: new Relation('parent', 'Org', 'orgId', 'id'),
        issues: new Relation('children', 'Issue', 'id', 'repoId'),
        repoRoles: new Relation('parent', 'RepoRole', 'id', 'repoId')
    };
    ...
    const userFields = {
        id: Number,
        repoRoles: new Relation('children', 'RepoRole', 'id', 'userId'),
        orgRoles: new Relation('children', 'OrgRole', 'id', 'userId')
    };
